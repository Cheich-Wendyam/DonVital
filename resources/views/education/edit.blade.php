        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Modifier le contenu : {{ $content->title }}</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('education.update', $content->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="category" name="category" required>
                                                        ...
                                                        @foreach(['discovery', 'preparation', 'quiz', 'testimonials'] as $category)
                                                            <option value="{{ $category }}" {{ $content->category == $category ? 'selected' : '' }}>
                                                                {{ ucfirst($category) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="difficulty" name="difficulty"
                                                        min="1" max="5" value="{{ old('difficulty', $content->difficulty) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="points" name="points"
                                                        value="{{ old('points', $content->points) }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div id="quiz-section" style="{{ $content->type == 'quiz' ? '' : 'display: none;' }}">
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="media">Télécharger un nouveau média</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        toggleQuizSection(); // Init on load
