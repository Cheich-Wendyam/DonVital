            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Statistiques Éducatives</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="card widget-box-one border border-primary">
                        <div class="card-body">
                            <div class="float-end avatar-lg rounded-circle bg-soft-primary">
                                <i class="mdi mdi-book-open-variant font-22 widget-icon"></i>
                            </div>
                            <div class="wigdet-one-content">
                                <p class="text-uppercase font-weight-bold text-muted">Contenus Actifs</p>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card widget-box-one border border-success">
                        <div class="card-body">
                            <div class="float-end avatar-lg rounded-circle bg-soft-success">
                                <i class="mdi mdi-comment-question-outline font-22 widget-icon"></i>
                            </div>
                            <div class="wigdet-one-content">
                                <p class="text-uppercase font-weight-bold text-muted">Quiz</p>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card widget-box-one border border-info">
                        <div class="card-body">
                            <div class="float-end avatar-lg rounded-circle bg-soft-info">
                                <i class="mdi mdi-check-all font-22 widget-icon"></i>
                            </div>
                            <div class="wigdet-one-content">
                                <p class="text-uppercase font-weight-bold text-muted">Complétions</p>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card widget-box-one border border-warning">
                        <div class="card-body">
                            <div class="float-end avatar-lg rounded-circle bg-soft-warning">
                                <i class="mdi mdi-account-multiple font-22 widget-icon"></i>
                            </div>
                            <div class="wigdet-one-content">
                                <p class="text-uppercase font-weight-bold text-muted">Utilisateurs Actifs (7j)</p>
